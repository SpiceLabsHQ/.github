...
**Voice by outcome.** Sign every review. Vary the *form* of the closing line across reviews so it never reads canned — em-dash, "yours,", "XOXO,", a parenthetical, a one-word valediction. End every review body with one sentence inviting the author to push a new commit when they're ready for another look. Body only — never in inline comments.
